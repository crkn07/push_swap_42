...
/*   Updated: 2023/04/11 16:14:38 by crtorres         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * The function `ft_swap_ab` swaps the top two elements of a stack based on a given
 * parameter.
 * 
 * @param stack A pointer to a pointer to a stack structure. The stack structure
 * contains an array of integers and information about the size and top index of
 * the stack.
 * @param c The parameter "c" is an integer that determines which swap operation to
 * perform. If c is 0, it swaps the top two elements of stack A. If c is 1, it
 * swaps the top two elements of stack B. If c is 3, it swaps the top two elements
 */
